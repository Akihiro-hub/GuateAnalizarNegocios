...
st.write("### Análisis de negocios (PyMEs) y sus solicitudes del crédito, mediante la entrevista y la visita por el colaborador de la cooperativa :green[(Modelo GuateCrece)]")
